...
//for the user
    ...
    public void onDirectionFinderSuccess(List<Route> routes) {
        ...
        for (Route route : routes) {
            ...
            master.distance=route.distance.text.toString();
            System.out.println("--------------------------------------------"+master.distance);
            ((TextView) findViewById(R.id.tvDistance)).setText(route.distance.text);

            Log.d("Ride Share", route.startLocation.toString());
            mMap.addMarker(new MarkerOptions().position(route.startLocation).title(route.startAddress));
            //originMarkers.add(mMap.addMarker(new MarkerOptions()
